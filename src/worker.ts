...
const simulationStageLabels: Readonly<Record<FluidSimulationStageId, string>> =
  Object.freeze({
    ...
    "volume-advection": "Advect chunked voxel fluid volume",
    "pressure-projection": "Project pressure and reduce divergence",
    "spectrum-advance": "Advance shared wave spectrum",
    "boundary-coupling": "Resolve boundaries and buoyancy coupling",
    "free-surface-extraction": "Extract free fluid surface from volume state",
    "surface-band-update": "Update near and distance fluid surface bands",
    "foam-spray-mask": "Generate foam, spray, and steam masks",
...
const interactiveWorkerProfileSpec: WorkerProfileSpec = Object.freeze({
  ...
  jobs: Object.freeze({
    ...
    "volume-advection": Object.freeze({
      label: "fluid.volume-advection",
      queueClass: "simulation",
      priority: 490,
      ...
      authority: "authoritative",
      importance: "critical",
      suggestedAllocationIds: Object.freeze(["fluid.volume"]),
      levels: {
        low: {
          estimatedCostMs: 0.8,
          maxDispatchesPerFrame: 1,
    ...
    "pressure-projection": Object.freeze({
      label: "fluid.pressure-projection",
      queueClass: "simulation",
      priority: 480,
      dependencies: Object.freeze(["volume-advection"]),
      domain: "physics",
      authority: "authoritative",
      importance: "critical",
      suggestedAllocationIds: Object.freeze(["fluid.pressure"]),
      levels: {
        low: {
          estimatedCostMs: 0.7,
          maxDispatchesPerFrame: 1,
    ...
    "boundary-coupling": Object.freeze({
      ...
      queueClass: "simulation",
      priority: 450,
      dependencies: Object.freeze(["pressure-projection"]),
      domain: "physics",
      authority: "authoritative",
      importance: "critical",
    ...
    "free-surface-extraction": Object.freeze({
      label: "fluid.free-surface-extraction",
      queueClass: "simulation",
      priority: 430,
      dependencies: Object.freeze(["boundary-coupling"]),
      domain: "physics",
      authority: "non-authoritative-simulation",
      importance: "high",
      suggestedAllocationIds: Object.freeze(["fluid.free-surface"]),
      levels: {
        low: {
          estimatedCostMs: 0.9,
          maxDispatchesPerFrame: 1,
    ...
    "surface-band-update": Object.freeze({
      label: "fluid.surface-band-update",
      queueClass: "render",
      priority: 425,
      dependencies: Object.freeze(["free-surface-extraction", "spectrum-advance"]),
      domain: "geometry",
      authority: "visual",
      importance: "high",
      suggestedAllocationIds: Object.freeze(["fluid.surface.band"]),
      levels: {
        low: {
          estimatedCostMs: 0.55,
          maxDispatchesPerFrame: 1,
    ...
    "near-surface": Object.freeze({
      ...
      queueClass: "render",
      priority: 420,
      dependencies: Object.freeze(["free-surface-extraction", "surface-band-update"]),
      domain: "geometry",
      authority: "visual",
      importance: "critical",
    ...
    "mid-surface": Object.freeze({
      ...
      queueClass: "render",
      priority: 330,
      dependencies: Object.freeze(["surface-band-update"]),
      domain: "geometry",
      authority: "visual",
      importance: "high",
    ...
    "foam-spray-mask": Object.freeze({
      label: "fluid.foam-spray-mask",
      queueClass: "render",
      priority: 310,
      dependencies: Object.freeze(["free-surface-extraction", "near-surface", "mid-surface"]),
      domain: "custom",
      authority: "visual",
      importance: "high",
      representationBand: "mid",
      ...
      suggestedAllocationIds: Object.freeze(["fluid.foam-spray"]),
      levels: {
        low: {
          estimatedCostMs: 0.2,
          maxDispatchesPerFrame: 1,
...
const interactiveSimulationStages: readonly FluidSimulationPlanStage[] = Object.freeze(
  [
    ...
    createSimulationStage({
      id: "volume-advection",
      label: simulationStageLabels["volume-advection"],
      queueClass: "simulation",
      root: false,
      dependencies: ["snapshot-ingest"],
      output: "voxel-fluid-volume",
      snapshotStable: true,
    }),
    createSimulationStage({
      id: "pressure-projection",
      label: simulationStageLabels["pressure-projection"],
      queueClass: "simulation",
      root: false,
      dependencies: ["volume-advection"],
      output: "divergence-reduced-volume",
      snapshotStable: true,
    }),
    createSimulationStage({
      id: "spectrum-advance",
    ...
    createSimulationStage({
      ...
      queueClass: "simulation",
      root: false,
      dependencies: ["pressure-projection"],
      output: "boundary-constraints",
      snapshotStable: true,
    }),
    createSimulationStage({
      id: "free-surface-extraction",
      label: simulationStageLabels["free-surface-extraction"],
      queueClass: "simulation",
      root: false,
      dependencies: ["boundary-coupling"],
      output: "free-surface-state",
      snapshotStable: true,
    }),
    createSimulationStage({
      id: "surface-band-update",
      label: simulationStageLabels["surface-band-update"],
      queueClass: "render",
      root: false,
      dependencies: ["free-surface-extraction", "spectrum-advance"],
      output: "surface-band-state",
      snapshotStable: true,
    }),
    createSimulationStage({
      id: "foam-spray-mask",
      label: simulationStageLabels["foam-spray-mask"],
      queueClass: "render",
      root: false,
      dependencies: ["free-surface-extraction", "surface-band-update"],
      output: "foam-spray-mask",
      snapshotStable: true,
    }),
    createSimulationStage({
      id: "near-surface",
    ...
    createSimulationStage({
      ...
      queueClass: "render",
      root: false,
      dependencies: ["surface-band-update"],
